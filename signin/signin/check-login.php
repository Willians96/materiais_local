...
class Check_login
{
    ...
    public function verificaUsuarioSenha($cpf, $senha)
    {
        ...
        $msSis = "PROTOCOLO";
        $msSubSis = "PROTOCOLO";
        //$wsUrl = "http://sistemas.intranet.policiamilitar.sp.gov.br/MS/aws_permxml.aspx?WSDL"; antigo
        ...
        switch ($erro) {
            case 0:
                ...
                //Verificar se usuário sistema
                Usuario::verificarUsuarioCadastrado($cpf, $senha);
                header('Location: index.php');
                exit();
            case 2:
                //$msg = 'CPF Inexistente';
    ...
    public function criarSessaoUsuario($usuario)
    {
        ...
        $dados = [
                    ...
                    're'      => $_SESSION['re'],
                    'opm'     => $_SESSION['unidade'],
                    'ip'      => '0'//Acessos::getClientIp()
                ];
        //Acessos::gravarAcesso($dados);
